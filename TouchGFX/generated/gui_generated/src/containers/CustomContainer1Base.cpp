...
CustomContainer1Base::CustomContainer1Base()
{
    ...
    Unicode::snprintf(textNumBuffer, TEXTNUM_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID33).getText());
    ...
    Unicode::snprintf(textDirBuffer, TEXTDIR_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID32).getText());
    ...
    Unicode::snprintf(textTimeBuffer, TEXTTIME_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID34).getText());
